      ...
      <div className="flex flex-col px-4 py-6 border-b border-border/20 relative">
        {!collapsed ? (
          <div className="flex items-center gap-3">
            <img src="/logo.png" className="w-8 h-8 rounded-lg shadow-md shrink-0 border border-primary/10 bg-white" alt="ADORA logo" />
            <div>
          ...
          <div className="flex justify-center py-1">
            <img src="/logo.png" className="w-8 h-8 rounded-lg shadow-sm bg-white" alt="ADORA logo" />
          </div>
        )}
        <button
